...
| 数据库中历史题目可正常判题 | ✅ | 2026-04-26 执行迁移，341 个步骤全部转为 v2 |
| 迁移脚本有完整日志 | ✅ | scripts/migrate-steps-to-v2.ts 支持 dry-run、进度报告、错误追踪 |
...
1. ~~**数据库迁移脚本未完成** (Task 27)~~ ✅ **已完成 (2026-04-26)**
   - ✅ 编写了 scripts/migrate-steps-to-v2.ts
   - ✅ 支持 dry-run 预览模式
   - ✅ 支持进度报告和错误追踪
   - ✅ 341 个数据库步骤全部迁移完成

2. **E2E 测试未完成** (Task 25)
   - 已创建 e2e/question-judgment-v2.spec.ts（13 个基础测试用例）
   - 建议：在后续迭代中完善测试覆盖
